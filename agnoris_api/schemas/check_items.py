...
#
#     def resolve_items_accumulated(self, args, context, info):
#         start_date = args.get("start_date")
#         if start_date is not None:
#             start_date = datetime.strptime(start_date, "%d/%m/%Y")
#         else:
#             start_date = datetime.today() - timedelta(days=7)
#         items = DashboardStorage().get_items_count(start_date)
#         return result_to_items_accumulated_array(items)
#
#     def resolve_items_per_day(self, args, context, info):
#         start_date = args.get("start_date")
#         if start_date is not None:
#             start_date = datetime.strptime(start_date, "%d/%m/%Y")
#         else:
#             start_date = datetime.today() - timedelta(days=7)
#         items = list(DashboardStorage().get_items_by_day(datetime.today() - timedelta(days=7)))
