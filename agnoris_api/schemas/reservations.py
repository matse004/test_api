...
#
#     def resolve_reservations(self, args, context, info):
#         reservations, last_check_id = DashboardStorage().retrieve_reservations(args)
#         return reservations
#
#     def resolve_guests(self, args, context, info):
#         return "BBBBB"
